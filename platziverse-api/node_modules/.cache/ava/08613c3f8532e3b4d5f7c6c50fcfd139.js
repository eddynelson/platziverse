...
test.serial.cb('/api/metrics/:uuid - no found', t => {
  request(server).get(`/api/metrics/${uuid}`).set('Authorization', `Bearer ${tokenNoAdmin}`).expect(500).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    ...
    t.falsy(_rec5._expr(_rec5._capt(err, 'arguments/0'), {
      content: 't.falsy(err, \'tiene que fallar la ruta /api/metric/\' + uuid)',
      filepath: 'tests/api-test.js',
      line: 146,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]},{"type":"BinaryExpression","operator":"+","left":{"type":"StringLiteral","value":"tiene que fallar la ruta /api/metric/","range":[13,52]},"right":{"type":"Identifier","name":"uuid","range":[55,59]},"range":[13,59]}],"range":[0,60]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"err","range":[8,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"string"},"value":"tiene que fallar la ruta /api/metric/","range":[13,52]},{"type":{"label":"+/-"},"value":"+","range":[53,54]},{"type":{"label":"name"},"value":"uuid","range":[55,59]},{"type":{"label":")"},"range":[59,60]}]',
      visitorKeys: _powerAssertVisitorKeys
...
//# sourceMappingURL=../node_modules/.cache/ava/08613c3f8532e3b4d5f7c6c50fcfd139.js.map