...
test.serial.cb('/api/metrics/:uuid - no found', t => {
  request(server).get(`/api/metrics/${uuid}`).set('Authorization', `Bearer ${tokenNoAdmin}`).expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
...
//# sourceMappingURL=../node_modules/.cache/ava/093ab062425f961dfb57aa9793f9f6f0.js.map