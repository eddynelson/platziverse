...
test.serial.cb('/api/agent/:uuid - not found', t => {
  request(server).get('/api/agent/eddy').expect(404).expect('X-Powered-By', /Express/).end((err, res) => {
...
//# sourceMappingURL=../node_modules/.cache/ava/2606cda983cec090188dc412a5aeb0d5.js.map