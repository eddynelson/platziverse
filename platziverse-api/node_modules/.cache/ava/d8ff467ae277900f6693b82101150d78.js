...
test.beforeEach(async () => {
  ...
  //token
  token = await sign({ username: 'platziverse', admin: true }, 'platziverse');
...
test.serial.cb('/api/agents', t => {
  request(server).get('/api/agents').set('Authorization', `Bearer ${token}`).expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    ...
    t.true(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(AgentStub, 'arguments/0/callee/object/object').findByConnected, 'arguments/0/callee/object').calledWith('h'), 'arguments/0'), {
      content: 't.true(AgentStub.findByConnected.calledWith(\'h\'))',
      filepath: 'tests/api-test.js',
      line: 62,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"AgentStub","range":[7,16]},"property":{"type":"Identifier","name":"findByConnected","range":[17,32]},"computed":false,"range":[7,32]},"property":{"type":"Identifier","name":"calledWith","range":[33,43]},"computed":false,"range":[7,43]},"arguments":[{"type":"StringLiteral","value":"h","range":[44,47]}],"range":[7,48]}],"range":[0,49]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"AgentStub","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"findByConnected","range":[17,32]},{"type":{"label":"."},"range":[32,33]},{"type":{"label":"name"},"value":"calledWith","range":[33,43]},{"type":{"label":"("},"range":[43,44]},{"type":{"label":"string"},"value":"h","range":[44,47]},{"type":{"label":")"},"range":[47,48]},{"type":{"label":")"},"range":[48,49]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
...
test.serial.todo('/api/agents - not admin');
//# sourceMappingURL=../node_modules/.cache/ava/d8ff467ae277900f6693b82101150d78.js.map