...
test.serial.cb('/api/agents', t => {
  request(server).get('/api/agents').expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    ...
    t.deepEqual(res.body, { agents: agentConnected }, `La respuesta ${res.body.message}, no es la correcta `);
    t.end();
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/005f1624d49e95327e0ce51b8738ad95.js.map