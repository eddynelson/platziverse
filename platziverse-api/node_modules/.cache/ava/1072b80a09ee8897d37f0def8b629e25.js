...
test.serial.cb('/api/agents', t => {
  request(server).get('/api/agents').set('Authorizate', `Bearer ${token}`).expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
...
//# sourceMappingURL=../node_modules/.cache/ava/1072b80a09ee8897d37f0def8b629e25.js.map