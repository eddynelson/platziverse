...
test.serial.todo('/api/agent/:uuid - not found', t => {
  request(server).get('/api/agent/yyy').expect(404).expect('X-Powered-By', /Express/).end((err, res) => {
    var _rec3 = new _powerAssertRecorder();

    t.falsy(_rec3._expr(_rec3._capt(err, 'arguments/0'), {
      content: 't.falsy(err, \'No puede mandar error\')',
      filepath: 'tests/api-test.js',
      line: 86,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]},{"type":"StringLiteral","value":"No puede mandar error","range":[13,36]}],"range":[0,37]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"err","range":[8,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"string"},"value":"No puede mandar error","range":[13,36]},{"type":{"label":")"},"range":[36,37]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), 'No puede mandar error');
  });
});
...
//# sourceMappingURL=../node_modules/.cache/ava/02e6f3518870b8c7b555aa239f0f6a22.js.map