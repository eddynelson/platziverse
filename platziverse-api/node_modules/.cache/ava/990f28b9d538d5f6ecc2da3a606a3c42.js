...
test.serial.cb('/api/agents', t => {
  request(server).get('/api/agents').expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    ...
    t.deepEqual(res.body, { agent: agentConnected }, `La respuesta ${res.body.message}, no es la correcta `);
    t.end();
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/990f28b9d538d5f6ecc2da3a606a3c42.js.map