...
test.serial.cb('/api/agents', t => {
  request(server).get('/api/agents').expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    ...
    t.deepEqual(body, { agents: agentConnected }, `La respuesta ${res.body.message}, no es la correcta `);
    t.end();
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/fd6103fba154b767befa6419ec357c0e.js.map