...
test.serial.cb('/api/agent/:uuid - not found', t => {
  request(server).get('/api/agent/yyy').expect(200).expect('X-Powered-By', /Express/).end((err, res) => {
...
//# sourceMappingURL=../node_modules/.cache/ava/8aeffb7f1add070dceb3584b427c4c4a.js.map