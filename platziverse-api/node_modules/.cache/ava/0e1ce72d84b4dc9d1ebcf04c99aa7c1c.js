...
test.serial.cb('/api/agents', t => {
  request(server).get('/api/agents').expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    ...
    t.deepEqual(res.body, agentConnected, `La respuesta ${res.body.message}, no es la correcta `);
    t.end();
  });
});
//# sourceMappingURL=../node_modules/.cache/ava/0e1ce72d84b4dc9d1ebcf04c99aa7c1c.js.map