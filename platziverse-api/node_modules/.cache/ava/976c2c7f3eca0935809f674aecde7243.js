...
test.serial.cb('/api/metrics/:uuid', t => {
  request(server).get(`/api/metrics/${uuid}`).set('Authorization', `Bearer ${tokenAdmin}`).expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    var _rec4 = new _powerAssertRecorder();

    t.falsy(_rec4._expr(_rec4._capt(err, 'arguments/0'), {
      content: 't.falsy(err, \'No puede ocurrir un error en la ruta /api/metric/\' + uuid)',
      filepath: 'tests/api-test.js',
      line: 128,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]},{"type":"BinaryExpression","operator":"+","left":{"type":"StringLiteral","value":"No puede ocurrir un error en la ruta /api/metric/","range":[13,64]},"right":{"type":"Identifier","name":"uuid","range":[67,71]},"range":[13,71]}],"range":[0,72]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"err","range":[8,11]},{"type":{"label":","},"range":[11,12]},{"type":{"label":"string"},"value":"No puede ocurrir un error en la ruta /api/metric/","range":[13,64]},{"type":{"label":"+/-"},"value":"+","range":[65,66]},{"type":{"label":"name"},"value":"uuid","range":[67,71]},{"type":{"label":")"},"range":[71,72]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), 'No puede ocurrir un error en la ruta /api/metric/' + uuid);
...
test.serial.cb('/api/metrics/:uuid - no found', t => {
  request(server).get(`/api/metrics/${uuid}`).set('Authorization', `Bearer ${tokenNoAdmin}`).expect(500).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    var _rec5 = new _powerAssertRecorder();

    t.true(_rec5._expr(_rec5._capt(err, 'arguments/0'), {
      content: 't.true(err, \'tiene que fallar la ruta /api/metric/\' + uuid)',
      filepath: 'tests/api-test.js',
      line: 146,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"Identifier","name":"err","range":[7,10]},{"type":"BinaryExpression","operator":"+","left":{"type":"StringLiteral","value":"tiene que fallar la ruta /api/metric/","range":[12,51]},"right":{"type":"Identifier","name":"uuid","range":[54,58]},"range":[12,58]}],"range":[0,59]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"err","range":[7,10]},{"type":{"label":","},"range":[10,11]},{"type":{"label":"string"},"value":"tiene que fallar la ruta /api/metric/","range":[12,51]},{"type":{"label":"+/-"},"value":"+","range":[52,53]},{"type":{"label":"name"},"value":"uuid","range":[54,58]},{"type":{"label":")"},"range":[58,59]}]',
      visitorKeys: _powerAssertVisitorKeys
    }), 'tiene que fallar la ruta /api/metric/' + uuid);
    t.end();
  });
});

test.serial.cb('/api/metrics/:uuid/:type', t => {
  request(server).get(`/api/metrics/${uuid}/${metricType}`).set('Authorization', `Bearer ${tokenAdmin}`).expect(200).expect('Content-Type', /json/).expect('X-Powered-By', /Express/).end((err, res) => {
    var _rec6 = new _powerAssertRecorder();

    t.falsy(_rec6._expr(_rec6._capt(err, 'arguments/0'), {
      content: 't.falsy(err, \'No puede ocurrir un error en la ruta /api/metric/\' + uuid)',
      filepath: 'tests/api-test.js',
      line: 159,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"err","range":[8,11]},{"type":"BinaryExpression","operator":"+","left":{"type":"StringLiteral","value":"No puede ocurrir un error en la ruta /api/metric/","range":[13,64]},"right":{"type":"Identifier","name":"uuid","range":[67,71]},"range":[13,71]}],"range":[0,72]}',
...
//# sourceMappingURL=../node_modules/.cache/ava/976c2c7f3eca0935809f674aecde7243.js.map