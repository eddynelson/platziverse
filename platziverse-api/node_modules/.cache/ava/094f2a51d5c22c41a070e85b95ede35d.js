...
test.serial.cb('/api/agent/:uuid - not found', t => {
  request(server).get('/api/agent/eddy').expect(200).expect('X-Powered-By', /Express/).end((err, res) => {
...
//# sourceMappingURL=../node_modules/.cache/ava/094f2a51d5c22c41a070e85b95ede35d.js.map